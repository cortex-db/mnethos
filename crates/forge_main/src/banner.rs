...
pub fn display(cli_mode: bool) -> io::Result<()> {
    ...
    let tips: Vec<(&str, &str)> = if cli_mode {
        ...
        vec![
            ...
            ("Switch agent:", ":<agent_name> e.g. :smith or :architect"),
        ]
    } else {
        ...
        vec![
            ...
            ("Switch model:", ":model"),
            ("Switch agent:", ":smith or :architect or :agent"),
            ("Update:", ":update"),
            ("Quit:", ":exit or <CTRL+D>"),
        ]
    };
...
fn display_zsh_encouragement() {
    let tip = DisplayBox::new(vec![
        ...
        format!(
            "{} {} {}",
            "·".dimmed(),
            "Set up Mnethos via our zsh plugin:".dimmed(),
            "mnethos zsh setup".bold().green(),
        ),
        format!(
            "{} {} {}",
            "·".dimmed(),
            "Learn more:".dimmed(),
            "https://mnethos.com/docs/zsh-support".cyan()
        ),
    ]);
    println!("{}", tip);
}
